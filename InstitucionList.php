            ...
            <table style="width:100%" > 
                <thead>
                    <tr class="breadcrumb mb-2">
                        ...
                        <?php if($SUsuaNivel==0){ ?>
                            <th>
                                <a href="InstitucionReg.php"><img src="imagen/BInstN.png" data-toggle="tooltip" data-placement="right" title="Nueva Institución" width="35" height="35"></a>
                            </th>
                        <?php } ?>
                    </tr>
		        </thead> 
...
<?php 
 ...
 <script>
    ...
    {
        document.getElementById("TInstEstatus").onchange =MostrarTabla;
    }
